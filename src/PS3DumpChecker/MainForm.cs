namespace PS3DumpChecker {
    ...
    internal sealed partial class MainForm : Form {
        ...
        public MainForm(ICollection <string> args) {
            ...
            _version = string.Format("PS3 Dump Checker v{0}.{1} Build: {2} RUS", app.GetName().Version.Major, app.GetName().Version.Minor, app.GetName().Version.Build, app.GetName().Version.Revision);
            Text = _version;
